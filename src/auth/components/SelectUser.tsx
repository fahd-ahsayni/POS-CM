...
export default function SelectUser() {
  ...
  return (
    <div className="relative w-1/2 bg-gray-100 hidden flex-1 lg:flex flex-col p-8">
      <nav>
        <img src={logoLightMode} alt="logo" className="w-28 h-auto" />
      </nav>
      <div className="mt-10">
      ...
      <div className="">
        ...
        <div className="h-0.5 max-w-xs mx-auto bg-zinc-50/50 rounded-full" />
