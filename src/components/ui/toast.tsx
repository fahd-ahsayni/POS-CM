...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed left-0 top-0 z-[100] flex max-h-screen w-full flex-col p-4 sm:max-w-[420px]",
      className
    )}
    {...props}
  />
...
>(({ className, variant, duration = 2500, ...props }, ref) => { // added duration with default value
  return (
    <ToastPrimitives.Root
      ref={ref}
      duration={duration} // pass duration to the underlying component
