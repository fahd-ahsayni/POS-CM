  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-md text-xs font-medium transition-colors outline-offset-2 focus-visible:outline focus-visible:outline-2 focus-visible:outline-ring/70 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        secondary:
          "dark:bg-secondary-black dark:text-neutral-400 text-neutral-700 dark:hover:bg-white dark:hover:text-primary-black bg-white hover:bg-primary-black hover:text-white disabled:pointer-events-none dark:disabled:bg-[#AAAAAA] dark:disabled:text-[#7E7E7E] disabled:bg-[#AAAAAA] disabled:text-[#7E7E7E] disabled:cursor-not-allowed border border-border",
        ghost:
